...
# i następnie ponownie wraca na pozątek pętli do spawdzenia warunku.

# Uwaga, ten przyład jest nienaturalny jak na język Python.
# Do przeglądania kolejnych liczb w Pythonie uzywa się for x in range...
x = 1
while x <= 5:
   print(x)
   x += 1
